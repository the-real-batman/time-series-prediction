...
while(itr<10):
   ...
   # print(set1)
    ...
    sum_of_percentage_error_abl_chen+=(error1/test.shape[0])
    sum_of_percentage_error_abl_weighted+=(error2/test.shape[0]) 
...
pyplot.ylabel('RMSE')
pyplot.legend()
plt.title('chen vs weighted for average based length')

pyplot.show()
print(sum_of_percentage_error_abl_chen/10)
print(sum_of_percentage_error_abl_weighted/10)
